...
- **Wav**: `vibe/data/authorship/authorship segment tests/segments-thru-Jun18/authorship_seg07_generated.wav`
- **Text**: `vibe/data/authorship/authorship segment tests/segments-thru-Jun18/authorship_seg07.txt`
- **GPU**: RTX 3090 (24GB)
...
- **Wav**: `vibe/data/authorship/authorship segment tests/segments-thru-Jun18/authorship_seg20_generated.wav`
- **Text**: `vibe/data/authorship/authorship segment tests/segments-thru-Jun18/authorship_seg20.txt`
- **GPU**: RTX A4000 (16GB)
...
- **Wav**: `vibe/data/authorship/authorship segment tests/segments-thru-Jun18/authorship_seg09_generated.wav`
- **Text**: `vibe/data/authorship/authorship segment tests/segments-thru-Jun18/authorship_seg09.txt`
...
- **Bad wav**: `vibe/data/authorship/authorship segment tests/segments-thru-Jun18/authorship_seg10_generated.wav`
- **Clean wav**: `vibe/data/authorship/authorship segment tests/2026-06-18 9-30a/authorship_seg10_generated.wav`
- **Text**: `vibe/data/authorship/authorship segment tests/segments-thru-Jun18/authorship_seg10.txt`
  (also at `vibe/data/authorship/authorship segment tests/2026-06-18 9-30a/authorship_seg10.txt`)
...
- **Wav**: `vibe/data/authorship/authorship segment tests/segments-thru-Jun18/authorship_seg14_generated.wav`
- **Text**: `vibe/data/authorship/authorship segment tests/segments-thru-Jun18/authorship_seg14.txt`
- **GPU (artifact run)**: RTX A4000 (16GB), pod tttf224qevgzyt
- **Symptom**: "Statement 3c -- and" → spoken as "Statement 3c tree fallack and"
- **Status**: Fixed. Current wav in `authorship segment tests/segments-thru-Jun18/` is the clean re-run
  (pod hst1oarkuu513x, RTX 3090 24GB) after em-dash fix. Original artifact wav
  was overwritten.

### seg15 — "lines -- things" artifact

- **Wav**: `vibe/data/authorship/authorship segment tests/segments-thru-Jun18/authorship_seg15_generated.wav`
- **Text**: `vibe/data/authorship/authorship segment tests/segments-thru-Jun18/authorship_seg15.txt`
- **GPU (artifact run)**: RTX A4000 (16GB), pod tttf224qevgzyt
...
- **Wav**: `vibe/data/authorship/authorship segment tests/segments-thru-Jun18/authorship_seg07_dialog_generated.wav`
- **Text**: `vibe/data/authorship/authorship segment tests/segments-thru-Jun18/authorship_seg07_dialog.txt`
...
- **Lesson**: Dialog format does not help short-sentence artifacts; splitting
  short fragments into the following paragraph (now done by
  `util::segmenter`, see `dev/setup.md`) is the effective fix.
